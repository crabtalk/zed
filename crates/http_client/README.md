...
`http_client` from [zed-industries/zed](https://github.com/zed-industries/zed), republished from the bezel project's fork so that the fork resolves from crates.io rather than from a git dependency.
